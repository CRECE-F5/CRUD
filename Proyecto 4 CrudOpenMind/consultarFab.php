...
<body>
    ...
    <tbody>
		<?php
			...
			$consultar = "SELECT fabrica.nombre, ciudad.nombre, pais.nombre FROM fabrica 
			INNER JOIN ciudad ON fabrica.fk_ciudad = ciudad.id_ciudad INNER JOIN pais ON ciudad.fk_pais = pais.id_pais
